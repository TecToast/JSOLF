...
// Shave off trailing zeros and decimal point, if possible.
    ...
    public static Object stringToValue(String string) {
        ...
        // check JSON keywords true/false/null
    ...
    public boolean getBoolean(Number key) {
    ...
    public BigInteger getBigInteger(Number key) {
    ...
    public BigDecimal getBigDecimal(Number key) {
    ...
    public double getDouble(Number key) {
    ...
    public float getFloat(Number key) {
    ...
    public Number getNumber(Number key) {
    ...
    public JSONArray getJSONArray(Number key) {
    ...
    public List<String> getStringList(Number key) {
    ...
    public List<JSONObject> getJSONList(Number key) {
        return this.getJSONList(key.toString());
    }
    ...
    public List<Long> getLongList(Number key) {
    ...
    public List<Integer> getIntList(Number key) {
        return this.getIntList(key.toString());
    }
    ...
    public JSONObject getJSONObject(Number key) {
    ...
    public long getLong(Number key) {
    ...
    public String getString(Number key) {
    ...
    /**
     * Removes all the elements from this JSONObject.
    ...
    public JSONObject put(Number key, boolean value) {
    ...
    public JSONObject put(Number key, Collection<?> value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, double value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, float value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, int value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, long value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, Map<?, ?> value) {
        return this.put(key.toString(), value);
    }
    ...
    public JSONObject put(Number key, Object value) {
        return this.put(key.toString(), value);
    }
